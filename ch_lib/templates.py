...
article = Template(util.dedent("""
    <article style="margin: 5px; clear: both;">
        ...
        <div style="font-size:20px;margin:6px 0px;">
            <b>模型：<a href="$url" target="_blank"><u>$model_name</u></a></b>
        </div>
    </article>
""").strip())
...
download = Template(util.dedent("""
    <div style="font-size:16px;margin:6px 0px;">
        新版本：<u><a href="$download_url" target="_blank" style="margin:0px 10px;">$new_version_name</a></u>
        <u><a href='#' style='margin:0px 10px;' onclick="ch_dl_model_new_version(event, '$model_path', '$new_version_id', '$download_url', '$model_type')">[下载到本地]</a></u>
    </div>
""").strip())

no_download = Template(util.dedent("""
    <div style="font-size:16px;margin:6px 0px;">
        新版本：$new_version_name
    </div>
""").strip())
